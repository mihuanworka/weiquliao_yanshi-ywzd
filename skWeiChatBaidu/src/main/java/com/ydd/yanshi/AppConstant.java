...
public class AppConstant {
    ...
    public static final int ZHONG_GUO_YOUZHENG_beijing = 107;//北京
    public static final int ZHONG_GUO_YOUZHENG_bohai = 108;//
    public static final int ZHONG_GUO_YOUZHENG_guangfa = 109;//
    public static final int ZHONG_GUO_YOUZHENG_hengfeng = 110;//
    public static final int ZHONG_GUO_YOUZHENG_huaxia = 111;//
    public static final int ZHONG_GUO_YOUZHENG_shanghai = 112;//
    public static final int ZHONG_GUO_YOUZHENG_wenzhou = 113;//
    public static final int ZHONG_GUO_YOUZHENG_xingye = 114;//
    public static final int ZHONG_GUO_YOUZHENG_zhaoshang = 115;//
    public static final int ZHONG_GUO_YOUZHENG_zheshang = 116;//
    public static final int ZHONG_GUO_YOUZHENG_zhongguoguangda = 117;//
    public static final int ZHONG_GUO_YOUZHENG_zhongguomingsheng = 118;//
    public static final int ZHONG_GUO_YOUZHENG_zhongxin = 119;//
