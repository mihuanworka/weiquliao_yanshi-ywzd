...
import static com.ydd.yanshi.util.Constants.KEY_TIME_DIFFERENCE;
...
public class TimeUtils {
    ...
    public static double sk_time_current_time_double() {
        long timeDifference = PreferenceUtils.getLong(MyApplication.getContext(), KEY_TIME_DIFFERENCE, 0);
        return new BigDecimal(String.valueOf(System.currentTimeMillis() + timeDifference)).divide(new BigDecimal("1000"), 5, RoundingMode.HALF_UP)
                .doubleValue();
    }
