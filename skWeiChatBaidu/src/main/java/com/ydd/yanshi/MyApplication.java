...
import com.ydd.yanshi.NetWorkObservable.NetWorkObserver;
...
import com.ydd.yanshi.ui.tool.MyFileNameGenerator;
...
import com.ydd.yanshi.util.ScreenShotListenManager;
import com.ydd.yanshi.volley.FastVolley;
...
public class MyApplication extends Application {
    ...
    private Handler killSelfHandler;
    ...
    public void onCreate() {
        ...
        killSelfHandler = new Handler(Looper.getMainLooper()){
            @Override
            public void handleMessage(Message msg) {
                System.out.println(">>>app exit normally!!!");
                try {
                    Iterator<Activity> iterator = runningActivities.iterator();
...
//        Reporter.init(this);
    ...
    private static void initBugly() {
        ...
        CrashReport.initCrashReport(getContext(), BuildConfig.BUGLY_APP_ID, false);
//        CrashReport.initCrashReport(getContext(), BuildConfig.BUGLY_APP_ID, BuildConfig.DEBUG && Log.isLoggable("Bugly", Log.DEBUG));
//        // 貌似设置了开发设备就不上报了，不是很靠得住，依然可能上报，
//        CrashReport.setIsDevelopmentDevice(getContext(), BuildConfig.DEBUG);
...
//        CrashReport.setAppChannel(getContext(), BuildConfig.BUGLY_APP_CHANNEL);
//        CrashReport.setAppVersion(getContext(), BuildConfig.VERSION_NAME + BuildConfig.VERSION_NAME_SUFFIX);
    }
    ...
    private void getAppBackground() {
        registerActivityLifecycleCallbacks(new ActivityLifecycleCallbacks() {
            ...
            public void onActivityStarted(Activity activity) {
                if (mActivityCount == 0) {
                    killSelfHandler.removeCallbacksAndMessages(null);
            ...
            public void onActivityStopped(Activity activity) {
                ...
                if (!AppUtils.isAppForeground(getContext())) {// 在app启动时，当启动页stop，而MainActivity还未start时，又会回调到该方法内，所以需要判断到底是不是真的处于后台
                    //5分钟之后自动关闭APP
                    killSelfHandler.sendMessageDelayed(Message.obtain(), 5 * 60 * 1000);
                    appBackstage(true);
                }
            }
