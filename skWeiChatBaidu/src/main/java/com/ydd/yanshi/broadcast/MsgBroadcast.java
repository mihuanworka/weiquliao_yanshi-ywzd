...
public class MsgBroadcast {
    ...
    public static void broadcastMsgNumReset(Context context) {
       LocalBroadcastManager.getInstance(MyApplication.getInstance()).sendBroadcast(new Intent(ACTION_MSG_NUM_RESET));
    }
    ...
    public static void broadcastMsgRoomUpdate(Context context) {
       LocalBroadcastManager.getInstance(MyApplication.getInstance()).sendBroadcast(new Intent(ACTION_MSG_UPDATE_ROOM));
    }

    public static void broadcastMsgRoleChanged(Context context) {
       LocalBroadcastManager.getInstance(MyApplication.getInstance()).sendBroadcast(new Intent(ACTION_MSG_ROLE_CHANGED));
    }

    public static void broadcastMsgRoomUpdateGetRoomStatus(Context context) {
       LocalBroadcastManager.getInstance(MyApplication.getInstance()).sendBroadcast(new Intent(ACTION_MSG_UPDATE_ROOM_GET_ROOM_STATUS));
    }
    ...
    public static void broadcastMsgColseTrill(Context context) {
       LocalBroadcastManager.getInstance(MyApplication.getInstance()).sendBroadcast(new Intent(ACTION_MSG_CLOSE_TRILL));
    }
