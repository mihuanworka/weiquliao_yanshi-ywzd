...
import com.ydd.yanshi.ui.message.HandleActivityDestroyedDoSomeThing;
...
public class FaceToFaceGroup extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initStep1();
        initStep2();
        LocalBroadcastManager.getInstance(this).registerReceiver(UpdateReceiver, new IntentFilter(MsgBroadcast.ACTION_FACE_GROUP_NOTIFY));
    }
