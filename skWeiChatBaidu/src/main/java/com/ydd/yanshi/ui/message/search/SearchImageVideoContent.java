package com.ydd.yanshi.ui.message.search;
    ...
    class ImageVideoAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
        ...
        public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, int position) {
            ...
            if (chatMessage.getType() == XmppMessage.TYPE_IMAGE) {
                ...
                Glide.with(mContext).load(isExist ? new File(chatMessage.getFilePath()) : chatMessage.getContent())
                        .error(R.drawable.image_download_fail_icon)
                        .dontAnimate().skipMemoryCache(true)
                        .diskCacheStrategy(DiskCacheStrategy.NONE)
                        .into((((ImageVideoHolder) viewHolder).mIv));
            } else {
