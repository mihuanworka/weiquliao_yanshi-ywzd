package com.ydd.yanshi.bean.message;
...
public class MucRoomMember {
    ...
    private long memberTalkTime; // 禁言时间
    ...
    public int getMemberTalkTime() {
        return  (int)  memberTalkTime;
    }

    public void setMemberTalkTime(long memberTalkTime) {
        this.memberTalkTime = memberTalkTime;
    }
