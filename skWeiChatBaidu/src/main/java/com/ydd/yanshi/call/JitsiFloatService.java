...
//                startActivity(intent);
    ...
    private void removeCastStop() {
        if (refreshBroadcastReceiverTimer != null) {
            LocalBroadcastManager.getInstance(this).unregisterReceiver(refreshBroadcastReceiverTimer);
        }
...
//                timer.setText(Jitsi_connecting_second.time);
    ...
    private void registerFloatingCast() {
        ...
        LocalBroadcastManager.getInstance(this).registerReceiver(refreshBroadcastReceiverTimer, intentFilter);
    }
