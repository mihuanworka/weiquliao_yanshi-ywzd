package com.ydd.yanshi.xmpp.helloDemon;
...
public class IntentWrapper {
    ...
    public static List<IntentWrapper> whiteListMatters(final Activity a, String reason) {
        ...
        if (showed.size() == 0) {// 说明没有可执行的intent 通知到设置界面
            LocalBroadcastManager.getInstance(MyApplication.getInstance()).sendBroadcast(new Intent(com.ydd.yanshi.broadcast.OtherBroadcast.NO_EXECUTABLE_INTENT));
        }
        return showed;
    }
