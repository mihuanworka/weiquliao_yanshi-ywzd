...
import com.ydd.yanshi.util.ThreadManager;
...
*/
    ...
    private Set<String> joiningRooms = new HashSet<>();

    public boolean isJoining(String roomId){
...
//            Log.e("zq", "未加入，去加入");
            ...
            if (isJoining(roomJid)){
                Log.e("zq","已有加入请求，忽略此次请求");
                return;
            }

            joiningRooms.add(roomJid);
            try {
                // 创建聊天室
                EntityBareJid mEntityBareJid = null;
                try {
