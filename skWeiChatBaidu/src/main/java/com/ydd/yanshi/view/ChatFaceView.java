...
import com.ydd.yanshi.ui.message.ManagerEmojiActivity;
import com.ydd.yanshi.util.SmileyParser;
...
public class ChatFaceView extends RelativeLayout {
    ...
    protected void onAttachedToWindow() {
        ...
        LocalBroadcastManager.getInstance(getContext()).registerReceiver(
                refreshCollectionListBroadcast, new IntentFilter(com.ydd.yanshi.broadcast.OtherBroadcast.CollectionRefresh));
    }

    @Override
    protected void onDetachedFromWindow() {
        super.onDetachedFromWindow();
        LocalBroadcastManager.getInstance(getContext()).unregisterReceiver(refreshCollectionListBroadcast);
    }
